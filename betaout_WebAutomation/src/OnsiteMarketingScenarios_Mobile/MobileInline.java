 ...
 * @author - Navpreet
 */
public class MobileInline {

	public static WebDriver driver;
	
	// Before running scenario, make changes on line number - 62
	
	
	@Test
	public void MobileLeadInline() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select MobileInlineTemplate > Design > Target > Active");
	...
	//	driver.navigate().refresh();
		...
		s_assert.assertEquals("GET OFFERS ON THE GO", InlineText);
		s_assert.assertAll();
		
		System.out.println("Banner is present on the URL");
		Thread.sleep(5000);
