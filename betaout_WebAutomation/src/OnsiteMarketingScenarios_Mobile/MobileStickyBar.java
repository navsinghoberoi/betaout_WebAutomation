...
public class MobileStickyBar {
	...
	@Test
	public void MobileLeadStickyBar() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select MobileStickyBarTemplate > Design > Target > Active");
	...
	//	driver.navigate().refresh();
	    ...
	    driver.switchTo().frame(driver.findElement(By.xpath("//*[contains(@id,'iframeinfobar')]")));
		...
		s_assert.assertEquals("GET OFFERS ON THE GO", StickybarText);
		s_assert.assertAll();
		
		System.out.println("Stickybar is present on the URL");
		Thread.sleep(5000);
