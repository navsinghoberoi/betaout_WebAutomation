...
public class MobilePullout {
	...
	@Test
	public void MobileLeadPullout() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select MobilePulloutTemplate > Design > Target > Active");
	...
	//	Date date1 = set.getCurrentDateTime();
		String name = "Auto_mobilepullout"+" "+System.currentTimeMillis();
		...
		template_obj.PulloutClick();              // Select pullout
		Thread.sleep(3000);
		template_obj.MobileLeadPullouttemplateClick();
	...
	//	Thread.sleep(18000);
		...
		design.MobileLeadSelectCountryClick_Pullout();
	...
	//	driver.navigate().refresh();
	    ...
	    driver.switchTo().frame(driver.findElement(By.xpath("//*[contains(@id,'iframesidekick')]")));
		
		driver.findElement(By.xpath("(//*[@class = 'btn_arrw'])[2]")).click();
	    ...
	    String PulloutText = driver.findElement(By.xpath("//*[@id = 'content-2-screen1']")).getText();
	    
	    driver.findElement(By.xpath("//*[@name = 'phone']")).sendKeys(prop.getProperty("Onsite_Number"));
	    
	    driver.findElement(By.xpath("(//*[@data-amplify-name = 'submitBtn'])")).click(); // Submit button
	    
	   
	    System.out.println(PulloutText);
			
		s_assert.assertEquals("GET OFFERS ON THE GO", PulloutText);
		s_assert.assertAll();
		
		System.out.println("Pullout is present on the URL");
		Thread.sleep(5000);
