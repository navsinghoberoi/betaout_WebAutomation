...
public class MobileBanner {
	...
	@Test
	public void MobileLeadBanner() throws Exception
	
	{
		System.out.println("Scenario : Onsite Marketing > Select MobileBannerTemplate > Design > Target > Active");
	...
	//	driver.navigate().refresh();
	    ...
	    driver.switchTo().frame(driver.findElement(By.xpath("//*[contains(@id,'iframeBanner')]")));
		...
		s_assert.assertEquals("GET OFFERS ON THE GO", BannerText);
		s_assert.assertAll();
