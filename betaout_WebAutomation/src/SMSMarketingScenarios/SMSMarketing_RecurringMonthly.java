 ...
 * @author - Navpreet
 */
public class SMSMarketing_RecurringMonthly {
	...
	@Test
	public void SMS_RecurringMonthly() throws Exception
	
	{
		System.out.println("Scenario : SMS Marketing > Campaigns > Recurring> Monthly > Create Campaign> Print counts and stats > Export CSV");
	...
	//	Date date1 = set.getCurrentDateTime();
		String name = "Auto_rec_monthly"+" "+System.currentTimeMillis();
		...
		design_obj.SMSTextClick("This is test message for Recurring SMS Marketing -> Monthly");
	...
	//	String MonthlyCampName = driver.findElement(By.xpath("(//*[@title = 'view design'])[1]")).getText();
		String MonthlyCampName = page_obj.RecurringCampaignName();
