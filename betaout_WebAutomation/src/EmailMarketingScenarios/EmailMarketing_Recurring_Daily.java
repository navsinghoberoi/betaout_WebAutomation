 ...
 * @author - Navpreet
 */
public class EmailMarketing_Recurring_Daily {
	...
	//	String name = prop.getProperty("Email_RecurringDaily_Name") + System.currentTimeMillis();
		...
		String name = prop.getProperty("Email_RecurringDaily_Name") + currentDate;
	...
	//	String subject_data = prop.getProperty("Email_RecurringDaily_Subject") + System.currentTimeMillis();
		...
		String subject_data = prop.getProperty("Email_RecurringDaily_Subject") + currentDate;
