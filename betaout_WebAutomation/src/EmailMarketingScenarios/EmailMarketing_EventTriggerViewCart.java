 ...
 * @author - Navpreet
 */
public class EmailMarketing_EventTriggerViewCart {
...
public static WebDriver driver;
	...
	@Test
	public void EventTrigger_ViewCart() throws Exception{
	...
	//	String name = prop.getProperty("EventTriggerViewCart_Name") + System.currentTimeMillis();
		
		String name = prop.getProperty("EventTriggerViewCart_Name") + currentDate;
		eventobj.EventTrigger_CampaignName(name);
		
		eventobj.EventTrigger_SaveCampaign();
		Thread.sleep(5000);
		
		eventobj.SelectEventFromDropdown("viewed_product");       // View Cart event
	...
	//	String subject_data = prop.getProperty("Email_EventTriggerViewCart_Subject") + System.currentTimeMillis();
		
		String subject_data = prop.getProperty("Email_EventTriggerViewCart_Subject") + currentDate;
	...
	//	eventobj.Sender_Id(prop.getProperty("EventTrigger_SenderID"));
		...
		Thread.sleep(1000);
		eventobj.Linkurl_NewURL(prop.getProperty("EventTriggerViewCartNewURL"));
		Thread.sleep(2000);
		...
		driver.findElement(carthome_obj.WoocommerceAccount_OpenAcuraCar).click();
		Thread.sleep(3000);
		...
		driver.findElement(carthome_obj.WoocommerceAccount_ViewCart).click();  // View cart
		Thread.sleep(3000);*/
	...
	//	EM_Broadcast_Template obj2 = new EM_Broadcast_Template(driver);
		...
		s_assert.assertEquals(prop.getProperty("EventTriggerViewCartNewURL"), ShortURL);
		Thread.sleep(2000);
