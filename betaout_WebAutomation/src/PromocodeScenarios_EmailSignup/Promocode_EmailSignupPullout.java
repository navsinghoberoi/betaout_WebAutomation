 ...
 * @author - Navpreet
 */
public class Promocode_EmailSignupPullout {
	...
	public void PromocodeOnEmailSignupPullout() throws Exception
...
//	Thread.sleep(18000);
	...
	String weburl = "EmailPullout_Promocode";
...
//	driver.navigate().refresh();
    ...
    String PulloutText = driver.findElement(By.xpath("//*[@id = 'content-5-screen1']")).getText();
