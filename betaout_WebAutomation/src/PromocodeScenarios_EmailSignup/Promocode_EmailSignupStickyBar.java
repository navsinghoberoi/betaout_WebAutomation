 ...
 * @author - Navpreet
 */
public class Promocode_EmailSignupStickyBar {
	...
	public void PromocodeOnEmailSignupStickyBar() throws Exception
	...
	// Now add code of Email Stickybar
...
//	Thread.sleep(18000);
	...
	String weburl = "EmailStickyBar_Promocode";
...
//	driver.navigate().refresh();
    ...
    String StickyBarText = driver.findElement(By.xpath("(//*[@class = 'limtd_heading'])[1]")).getText();
	...
	s_assert.assertEquals("A1LIMITED OFFER", StickyBarText);
	s_assert.assertAll();
