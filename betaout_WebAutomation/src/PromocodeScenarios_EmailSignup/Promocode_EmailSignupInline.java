 ...
 * @author - Navpreet
 */
public class Promocode_EmailSignupInline {
...
//	Thread.sleep(18000);
	...
	String weburl = "EmailInline_Promocode";
...
//	driver.navigate().refresh();
	...
	s_assert.assertEquals("A1LIMITED OFFER", InlineText);
	s_assert.assertAll();
