 ...
 * @author - Navpreet
 */
public class Promocode_EmailSignupBanner {
	...
	public void PromocodeOnEmailBanner() throws Exception
...
//	Date date1 = set.getCurrentDateTime();
	String name = "Auto_emailbanner"+" "+System.currentTimeMillis();
...
//	Thread.sleep(18000);
	...
	String weburl = "EmailBanner_Promocode";
...
//	driver.navigate().refresh();
	...
	s_assert.assertEquals("A1LIMITED OFFER", BannerText);
	s_assert.assertAll();
