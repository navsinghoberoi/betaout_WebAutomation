 ...
 * @author - Navpreet
 */
public class EmailSignupPullout {
	...
	@Test
	public void EmailPullout() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select EmailSignupPulloutTemplate > Design > Target > Active");
	...
	//	Date date1 = set.getCurrentDateTime();
		String name = "Auto_emailpullout"+" "+System.currentTimeMillis();
		...
		Thread.sleep(3000);
		template_obj.EmailSignupPullouttemplateClick();
	...
	//	driver.navigate().refresh();
	    ...
	    String PulloutText = driver.findElement(By.xpath("(//*[text() = ' LIMITED OFFER'])[1]")).getText();
		...
		s_assert.assertEquals("LIMITED OFFER", PulloutText);
		s_assert.assertAll();
