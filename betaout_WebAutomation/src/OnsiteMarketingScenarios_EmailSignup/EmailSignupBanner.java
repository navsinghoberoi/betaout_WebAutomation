 ...
 * @author - Navpreet
 */
public class EmailSignupBanner {

	public static WebDriver driver;
	
	
	@Test
	public void EmailBanner() throws Exception
	
	{
		System.out.println("Scenario : Onsite Marketing > Select EmailBannerTemplate > Design > Target > Active");
	...
	//	calltoaction_obj.PrintCampaignPopupDetails();
		...
		String name = "Auto_emailbanner"+" "+currentDate;
		...
		Thread.sleep(3000);
		template_obj.EmailSignupBannertemplateClick();
	...
	//	driver.navigate().refresh();
	    ...
	    String BannerText = driver.findElement(By.xpath("//*[@class = 'focus']")).getText();
	    
	    driver.findElement(By.xpath("//*[@name = 'email']")).sendKeys("navpreet@socialcrawler.in");
	    
	    driver.findElement(By.xpath("(//*[@data-amplify-name = 'submitBtn'])")).click();
	    System.out.println(BannerText);
			
		s_assert.assertEquals("LIMITED OFFER", BannerText);
		s_assert.assertAll();
