...
public class EmailSignupPopup {
	...
	@Test
	public void EmailPopup() throws Exception
	
	{
		System.out.println("Scenario : Onsite Marketing > Select EmailSignupPopupTemplate > Design > Target > Active");
	...
	//	driver.navigate().refresh();
		...
		s_assert.assertEquals("LIMITED OFFER", PopupText);
		s_assert.assertAll();
