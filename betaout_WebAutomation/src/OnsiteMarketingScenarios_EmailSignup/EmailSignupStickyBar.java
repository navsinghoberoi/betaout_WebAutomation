 ...
 * @author - Navpreet
 */
public class EmailSignupStickyBar {
	...
	@Test
	public void EmailStickyBar() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select EmailStickyBarTemplate > Design > Target > Active");
	...
	//	Date date1 = set.getCurrentDateTime();
		String name = "Auto_emailstickybar"+" "+System.currentTimeMillis();
		...
		Thread.sleep(3000);
		template_obj.EmailSignupStickyBartemplateClick();
	...
	//	driver.navigate().refresh();
	    ...
	    String StickyBarText = driver.findElement(By.xpath("(//*[text() = ' LIMITED OFFER'])[1]")).getText();
		...
		s_assert.assertEquals("LIMITED OFFER", StickyBarText);
		s_assert.assertAll();
