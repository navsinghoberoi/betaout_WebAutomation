...
public class CTAInline {
	...
	@Test
	public void CallToActionInline() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select CTAInlineTemplate > Design > Target > Active");
	...
	//	driver.navigate().refresh();
	    ...
	    String InlineText = driver.findElement(By.xpath("(//*[text() = 'HEADPHONES'])")).getText();
	    System.out.println(InlineText);
			
		s_assert.assertEquals("HEADPHONES", InlineText);
		s_assert.assertAll();
