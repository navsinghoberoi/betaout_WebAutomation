...
public class CTAStickyBar {
	...
	@Test
	public void CallToActionStickyBar() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select CTAStickyBarTemplate > Design > Target > Active");
	...
	//	Date date1 = set.getCurrentDateTime();
		String name = "Auto_ctastickybar"+" "+System.currentTimeMillis();
		...
		Thread.sleep(3000);
		template_obj.CTAStickyBartemplateClick();
	...
	//	driver.get("http://woocommerce.basera.com/?CTAPopup");
	...
	//	driver.navigate().refresh();
	    ...
	    String StickybarText = driver.findElement(By.xpath("//*[@id = 'content-1']")).getText();
	    System.out.println(StickybarText);
			
		s_assert.assertEquals("HEADPHONES", StickybarText);
		s_assert.assertAll();
