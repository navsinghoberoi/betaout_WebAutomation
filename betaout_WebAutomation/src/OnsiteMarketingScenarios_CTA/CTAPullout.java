...
public class CTAPullout {
	...
	@Test
	public void CallToActionPullout() throws Exception
	
	
	{
		System.out.println("Scenario : Onsite Marketing > Select CTAPulloutTemplate > Design > Target > Active");
	...
	//	driver.navigate().refresh();
	    ...
	    String PulloutText = driver.findElement(By.xpath("(//*[text() = 'HEADPHONES'])")).getText();
	    System.out.println(PulloutText);
			
		s_assert.assertEquals("HEADPHONES", PulloutText);
		s_assert.assertAll();
