 ...
 * @author - Navpreet
 */
public class SMSMarketing_Recurring_Active {
...
//	By EndDate_SelectDate = By.xpath(("(//*[@class = 'day' and text()='10'])[2]"));
...
//	By Exclusion_SelectDate = By.xpath(("(//*[@class = 'day' and text()='10'])[2]"));
	...
	By Broad_DeleteConfirm = By.xpath("//*[contains(@class,'ConfirmDeleteSMSCampaign')]");
	
	public SMSMarketing_Recurring_Active(WebDriver driver)
	{
		this.driver = driver;
	}
