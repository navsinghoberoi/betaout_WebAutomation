...
public class Onsite_Select_Template {
	...
	By Inline_Mobile = By.xpath("(//*[@src = '/images/inSite.png'])");
	...
	By CTAPopuptemplate = By.xpath("//a[@data-tid = '381']"); // Recommendation																													// popup3
	By CTAPullouttemplate = By.xpath("//a[@data-tid = '407']");
	By CTAStickyBartemplate = By.xpath("//a[@data-tid = '385']");
	By CTAInlinetemplate = By.xpath("//a[@data-tid = '409']");
	By CTABannertemplate = By.xpath("//a[@data-tid = '406']");

	By EmailSignupPopuptemplate = By.xpath("//a[@data-tid = '365']");
	...
	By MobileLeadPopuptemplate = By.xpath("//a[@data-tid = '378']"); 																									// Popup
	...
	public void InlineMobileClick()

	{

		driver.findElement(Inline_Mobile).click();
