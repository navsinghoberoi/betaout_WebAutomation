 ...
 * @author - Navpreet
 */
public class MobilePush_RecurringDaily {
	...
	public void Mobile_DailyCampaign() throws Exception
	...
	//	obj.upswd("123456");
		...
		String campaignNameEntered = "Rec_daily"+System.currentTimeMillis();
		obj1.broadcastImage();
	...
	//	driver.findElement(By.xpath("(//*[@data-action = 'incrementHours'])")).click(); // Increement 1hr time
		...
		s_assert.assertEquals(DailyCampName, campaignNameEntered);
		s_assert.assertAll();
