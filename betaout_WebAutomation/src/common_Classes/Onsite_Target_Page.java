...
public class Onsite_Target_Page {
	...
	By Target_Users = By.xpath(".//*[@data-lockdiv='t1']");      // toa activate target users
...
public void TP_SpecificURL_click()

{
	...
	driver.findElement(By.xpath("//*[@class = 'form-control targetSpecificPage ']")).clear(); // URL
	driver.findElement(By.xpath("//*[@class = 'form-control targetSpecificPage ']")).sendKeys("CTAPopup"); // URL
