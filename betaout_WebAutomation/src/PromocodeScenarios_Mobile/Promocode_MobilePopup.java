 ...
 * @author - Navpreet
 */
public class Promocode_MobilePopup {
	...
	public void PromocodeOnMobilePopup() throws Exception
...
//	Date date1 = set.getCurrentDateTime();
	...
	String weburl = "MobilePopup_Promocode";
...
//	driver.navigate().refresh();
    ...
    driver.findElement(By.xpath("//*[@id = 'Your_EmaIl']")).sendKeys(prop.getProperty("SMSNumber"));
//	driver.findElement(By.xpath("//*[@data-amplify-name = 'submitBtn']")).click();  // Submit button	
    
	s_assert.assertEquals("A1GET OFFERS ON THE GO", PopupText);
	s_assert.assertAll();
