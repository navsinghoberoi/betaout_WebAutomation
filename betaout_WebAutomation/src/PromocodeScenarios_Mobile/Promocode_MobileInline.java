 ...
 * @author - Navpreet
 */
public class Promocode_MobileInline {
...
//	Date date1 = set.getCurrentDateTime();
	String name = "Auto_mobileinline"+" "+System.currentTimeMillis();
...
//	driver.navigate().refresh();
    ...
    String InlineText = driver.findElement(By.xpath("//*[@id = 'content-1-screen1']")).getText();
