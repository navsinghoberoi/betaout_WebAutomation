 ...
 * @author - Navpreet
 */
public class Promocode_MobileBanner {
	...
	public void PromocodeOnMobileBanner() throws Exception
...
//	Date date1 = set.getCurrentDateTime();
	String name = "Auto_mobilebanner"+" "+System.currentTimeMillis();
	...
	Thread.sleep(3000);
	template_obj.MobileLeadBannertemplateClick();
...
//	Thread.sleep(18000);
	...
	design.MobileLeadSelectCountryClick_Banner();
	...
	String weburl = "MobileBanner_Promocode";
...
//	driver.navigate().refresh();
    ...
    driver.switchTo().frame(driver.findElement(campaign_obj.BannerIframe));
    ...
    String BannerText = driver.findElement(By.xpath("//*[@id = 'content-1-screen1']")).getText();
...
//    driver.findElement(By.xpath("(//*[@data-amplify-name = 'submitBtn'])")).click(); // Submit button
	...
	s_assert.assertEquals("A1GET OFFERS ON THE GO", BannerText);
	s_assert.assertAll();
