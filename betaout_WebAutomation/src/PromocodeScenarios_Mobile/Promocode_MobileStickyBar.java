 ...
 * @author - Navpreet
 */
public class Promocode_MobileStickyBar {
	...
	public void PromocodeOnMobileStickybar() throws Exception
	...
	// Now add code of Mobile StickyBar
...
//	Date date1 = set.getCurrentDateTime();
	String name = "Auto_mobilesticky"+" "+System.currentTimeMillis();
	...
	template_obj.StickyBarClick();            // Select stickybar
	Thread.sleep(3000);
	template_obj.MobileLeadStickyBartemplateClick();
...
//	Thread.sleep(18000);
	...
	driver.findElement(By.xpath("//*[@id = 'content-1-screen1']")).click();    // Click to display Countdown tab
	Thread.sleep(2000);
	
	driver.findElement(campaign_obj.CouponCodeDesignPage).click();    // Click on CouponCode (Not visible by default)
	Thread.sleep(6000);
	
	driver.switchTo().frame(driver.findElement(campaign_obj.CouponCodeDesignPage));
	...
	design.MobileLeadSelectCountryClick_StickyBar();
	...
	String weburl = "MobileStickyBar_Promocode";
...
//	driver.navigate().refresh();
    ...
    driver.switchTo().frame(driver.findElement(campaign_obj.StickybarBanner));
    ...
    String StickybarText = driver.findElement(By.xpath("//*[@id = 'content-1-screen1']")).getText();
...
//    driver.findElement(By.xpath("(//*[@data-amplify-name = 'submitBtn'])")).click(); // Submit button
    ...
    System.out.println(StickybarText);
		
	s_assert.assertEquals("A1GET OFFERS ON THE GO", StickybarText);
	s_assert.assertAll();
	
	System.out.println("Stickybar with promocode is present on the URL");
	Thread.sleep(5000);
