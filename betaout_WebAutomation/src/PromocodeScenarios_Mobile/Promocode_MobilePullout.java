 ...
 * @author - Navpreet
 */
public class Promocode_MobilePullout {
	...
	public void PromocodeOnMobilePullout() throws Exception
	...
	// Now add code of Mobile Pullout
...
//	Thread.sleep(18000);
	...
	String weburl = "MobilePullout_Promocode";
...
//	driver.navigate().refresh();
    ...
    driver.switchTo().frame(driver.findElement(campaign_obj.PulloutIframe));
    ...
    String PulloutText = driver.findElement(By.xpath("(//*[@class = 'head_text'])[1]")).getText();
...
//    driver.findElement(By.xpath("(//*[@data-amplify-name = 'submitBtn'])")).click(); // Submit button
	...
	s_assert.assertEquals("A1GREAT DEALS !", PulloutText);
	s_assert.assertAll();
	
	System.out.println("Pullout with promocode is present on the URL");
	Thread.sleep(5000);
