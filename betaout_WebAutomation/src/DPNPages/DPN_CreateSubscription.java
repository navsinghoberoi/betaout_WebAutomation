 ...
 * @author - Navpreet
 */
public class DPN_CreateSubscription {
	...
	By ChooseDefaultDesign = By.xpath("//*[contains(@class,'choose_campgn_box1')]");
	By Cancel = By.xpath("(//*[@class = 'cancel'])");
	By SaveNext = By.xpath("(//*[@name = 'saveCampaignBtn'])");
	
	
	//Target Page     (Same as Onsite Marketing)
	...
	By Schedule = By.xpath("//*[contains(text(),'Set Date & Time')]");
	By Inactive = By.xpath("//*[text() = 'Inactivate for Now']");
	By Activate = By.xpath("//*[@value = 'active']");
	
	
	
	public DPN_CreateSubscription(WebDriver driver)
	{
		this.driver = driver;
	}
	
	
	public void setCampaginsTitle(String title)
	{
		driver.findElement(CampaginsTitle).sendKeys(title);
	}
	
	public void ChooseDefaultDesign()
	{
		driver.findElement(ChooseDefaultDesign).click();
	}
