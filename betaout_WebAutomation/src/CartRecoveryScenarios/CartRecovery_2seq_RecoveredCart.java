...
public class CartRecovery_2seq_RecoveredCart {
	...
	
	{
		...
		System.out.println("Scenario : Create Camp > Sequence1 > Check mail > Verify stats > Sequence2 (with short URL)> Check mail > recover cart > verify stats > Inactivate campaign ");
