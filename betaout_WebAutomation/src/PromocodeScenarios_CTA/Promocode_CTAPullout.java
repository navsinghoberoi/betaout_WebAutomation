package PromocodeScenarios_CTA;
...
import OnsiteMarketingPages.Onsite_Activepage;
 ...
 * @author - Navpreet
 */
public class Promocode_CTAPullout {
	...
	public void PromocodeOnCTAPullout() throws Exception
	...
	System.out.println("Assertion of CouponList Name is done successfully");
		...
		// Now add code of CTA Pullout (Make changes for Promocode)
...
//	Date date1 = set.getCurrentDateTime();
	String name = "Auto_ctapullout"+" "+System.currentTimeMillis();
	...
	Thread.sleep(3000);
	template_obj.CTAPullouttemplateClick();
...
//	Thread.sleep(18000);
	...
	design.PulloutOpenedRadioButton();       // Opened Pullout Tab View
	Thread.sleep(1500);		
	design.save_next();
	Thread.sleep(12000);
	...
	String weburl = "CTAPullout_Promocode";
...
//	driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL,"t");   	// Open new tab
 ...
 //	driver.navigate().refresh();
    ...
    String PulloutText = driver.findElement(By.xpath("//*[@id = 'content-1']")).getText();
    System.out.println(PulloutText);
		
	s_assert.assertEquals("A1GREAT DEALS !", PulloutText);        // Coupon Code is written along with Great Deals
	s_assert.assertAll();
