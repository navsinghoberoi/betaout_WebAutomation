 ...
 * @author - Navpreet
 */
public class Promocode_CTABanner {
public static WebDriver driver;
	
	
	@Test
	
	public void PromocodeOnCTABanner() throws Exception
...
//	Thread.sleep(18000);
	...
	String weburl = "CTABanner_Promocode";
...
//	driver.navigate().refresh();
    ...
    String BannerText = driver.findElement(By.xpath("//*[contains(text(),'HEADPHONES')]")).getText();
    System.out.println(BannerText);
		
	s_assert.assertEquals("A1HEADPHONES", BannerText);
	s_assert.assertAll();
