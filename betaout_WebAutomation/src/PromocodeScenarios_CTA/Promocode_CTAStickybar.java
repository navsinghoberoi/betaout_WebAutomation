 ...
 * @author - Navpreet
 */
public class Promocode_CTAStickybar {
	...
	public void PromocodeOnCTAStickybar() throws Exception
...
//	Thread.sleep(18000);
	...
	String weburl = "CTAStickyBar_Promocode";
...
//	driver.navigate().refresh();
	...
	s_assert.assertEquals("A1HEADPHONES", StickybarText);
	s_assert.assertAll();
