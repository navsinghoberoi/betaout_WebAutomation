 ...
 * @author - Navpreet
 */
public class Promocode_CTAInline {
	...
	public void PromocodeOnInline() throws Exception
...
//	Date date1 = set.getCurrentDateTime();
	String name = "Auto_ctainline"+" "+System.currentTimeMillis();
	...
	Thread.sleep(3000);
	template_obj.CTAInlinetemplateClick();
...
FileUtils.copyFile(scrFile, new File("./Screenshots/"+this.getClass()+System.currentTimeMillis()+".png"));
	...
	String weburl = "CTAInline_Promocode";
...
FileUtils.copyFile(scrFile1, new File("./Screenshots/"+this.getClass()+System.currentTimeMillis()+".png"));
    ...
    String InlineText = driver.findElement(By.xpath("//*[contains(text(),'HEADPHONES')]")).getText();
    System.out.println(InlineText);
		
	s_assert.assertEquals("A1HEADPHONES", InlineText);
	s_assert.assertAll();
	
	System.out.println("Inline with promocode is present on the URL");
	Thread.sleep(5000);
