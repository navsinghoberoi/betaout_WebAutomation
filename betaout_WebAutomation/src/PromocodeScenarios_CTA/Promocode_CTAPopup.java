 ...
 * @author - Navpreet
 */
public class Promocode_CTAPopup {
	...
	public void PromocodeOnCTAPopup() throws Exception
	...
	//	calltoaction_obj.PrintCampaignPopupDetails();
		...
		String name = System.currentTimeMillis()+""+"Auto_ctapopup";
	...
	/*	driver.findElement(By.xpath("(.//*[@id='couponCodeSearch'])")).sendKeys("s");*/
		         // Not able to find radio button by searching campaignname
		...
		String weburl = "CTAPopup_Promocode";
	...
	//	driver.navigate().refresh();
		...
		s_assert.assertEquals("A1HEADPHONES", PopupText);
		s_assert.assertAll();
